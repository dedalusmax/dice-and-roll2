const FONT_FAMILY = 'Berkshire Swash'; // alternatives: Handlee, Kaushan Script
...
export class Styles {
    ...
    public static readonly text = {
        ...
        header: { font: '24px ' + FONT_FAMILY, strokeThickness: 1 },
    ...
    public static readonly menu = {
        ...
        author: { font: '32px ' + FONT_FAMILY, fill: '#FF6A00', align: 'center' },
        author_small: { font: '24px ' + FONT_FAMILY, strokeThickness: 1, fill: '#990000' },
        menu_button: { font: '72px ' + FONT_FAMILY, fill: '#990000', align: 'center', stroke: '#000000', strokeThickness: 2 },
