...
export class MainMenuScene extends Phaser.Scene {
    ...
    createSkirmishMenu() {
        ...
        this.scene.start('LoadingScene', { loadScene: 'BattleScene', persistMusic: false,
            ...
            playerParty: [ Assets.characters.gunslinger, Assets.characters.alchemist ], //, Assets.characters.musketeer, Assets.characters.assasin, Assets.characters.illusionist ],
